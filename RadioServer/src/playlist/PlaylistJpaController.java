...
import playlist.exceptions.NonexistentEntityException;
import playlist.exceptions.PreexistingEntityException;
...
public class PlaylistJpaController implements Serializable {
    ...
    public void create(Playlist playlist) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPlaylist(playlist.getNume()) != null) {
